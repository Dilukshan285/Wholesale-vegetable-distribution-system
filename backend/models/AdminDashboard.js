...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    // Fetch farmer count
    fetch('http://localhost:8060/farmer/api/farmers/count')
    ...
    fetch('http://localhost:8060/pickup-request/api/pickup-requests/count')
      .then(response => response.json())
    ...
    fetch('http://localhost:8060/cropReadiness/api/crop-readiness/count')
      .then(response => response.json())
      .then(data => {
